...
<head>
	...
	<body class="defult-home">
		...
		<div class="main-content">
			...
			<div class="rs-breadcrumbs img2">
			    <div class="container">
			        <div class="breadcrumbs-inner">
			            <h1 class="page-title">
			                project
			                <span class="watermark">project</span>
			            </h1>
			...
			<!-- Project Start -->
			<div class="rs-project project-style6 pt-120 pb-120 md-pt-80 md-pb-80">
				<div class="container">
					<div class="row">
						<div class="col-lg-4 col-md-6 mb-30">
							<div class="project-item">
							    <div class="project-img">
							        <a href="#"><img src="{{ asset('frontend_css/assets/images/project/style2/1.jpg')}}" alt="images"></a>
							    </div>
						...
						<div class="col-lg-4 col-md-6 mb-30">
							<div class="project-item">
							    <div class="project-img">
							        <a href="#"><img src="{{ asset('frontend_css/assets/images/project/style2/2.jpg')}}" alt="images"></a>
							    </div>
							   	<div class="project-inner">
							   		<span class="category"><a href="#">Consulting</a></span>
							   	    <h3 class="title"><a href="#">Digital Customer Experience Strategy</a></h3>
							   	</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6 mb-30">
							<div class="project-item">
							    <div class="project-img">
							        <a href="#"><img src="{{ asset('frontend_css/assets/images/project/style2/3.jpg')}}" alt="images"></a>
							    </div>
							   	<div class="project-inner">
							   		<span class="category"><a href="#">Finance</a></span>
							   	    <h3 class="title"><a href="#">Next-Generation Outsourcing Business</a></h3>
							   	</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6 md-mb-30">
							<div class="project-item">
							    <div class="project-img">
							        <a href="#"><img src="{{ asset('frontend_css/assets/images/project/style2/4.jpg')}}" alt="images"></a>
							    </div>
							   	<div class="project-inner">
							   		<span class="category"><a href="#">Marketing</a></span>
							   	    <h3 class="title"><a href="#">Proper Path Strategy in Your Business</a></h3>
							   	</div>
							</div>
						</div>
						<div class="col-lg-4 col-md-6 sm-mb-30">
							<div class="project-item">
							    <div class="project-img">
							        <a href="#"><img src="{{ asset('frontend_css/assets/images/project/style2/5.jpg')}}" alt="images"></a>
							    </div>
							   	<div class="project-inner">
							   		<span class="category"><a href="#">Business</a></span>
							   	    <h3 class="title"><a href="#">Implementation of a Business Strategy</a></h3>
						...
						<div class="col-lg-4 col-md-6">
							<div class="project-item">
							    <div class="project-img">
							        <a href="#"><img src="{{ asset('frontend_css/assets/images/project/style2/6.jpg')}}" alt="images"></a>
							    </div>
							   	<div class="project-inner">
							   		<span class="category"><a href="#">Business</a></span>
							   	    <h3 class="title"><a href="#">Implementation of a Business Strategy</a></h3>
